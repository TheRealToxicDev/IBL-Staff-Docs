...
> NOTE: You can Ignore the `Use Netlify DNS` option in The Domain Config shown above 👆! It's not needed and extra work to setup something that your Domain host should offer out the gate!
